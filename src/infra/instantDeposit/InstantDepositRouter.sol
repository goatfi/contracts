...
import { IPermit2 } from "interfaces/infra/instantDeposit/IPermit2.sol";
import { TokenManager} from "./TokenManager.sol";
import { InstantDepositErrors } from "./InstantDepositErrors.sol";

/**
 * @title Instant Deposit Reouter for Goat Vaults
 * @author kexley, Beefy.
 * @notice Adaptable router for instant depositing tokens to and from Goat vaults
 * @dev Router that allows arbitary calls to external contracts. Users can instant deposit directly or sign 
 * using Permit2 to allow a relayer to execute the instant deposits on their behalf. Do not directly approve this
 * contract for spending your tokens, approve the TokenManager instead
 */
contract InstantDepositRouter is IInstantDepositRouter, InstantDepositErrors, Ownable, Pausable, ReentrancyGuard {
    ...
    /**
     * @notice Token and amount sent to the recipient at end of an instant deposit
    ...
    /**
     * @notice External relay call at end of instant deposit
    ...
    /**
     * @dev Call an external contract at the end of an instant deposit with a payload signed in the order
    ...
    /**
     * @notice Pause the contract from carrying out any more instant deposits
    ...
    /**
     * @notice Unpause the contract to allow new instant deposits
