...
/**
 * @title Instant Deposit router interface
 * @author kexley, Beefy
 * @notice Interface for instant deposit router that contains the structs for orders and routes
 */
interface IInstantDepositRouter {
    /**
     * @dev Input token and amount used in a step of the instant deposit
    ...
    /**
     * @dev Output token and amount from the end of the instant deposit
     * @param token Address of token
    ...
    /**
     * @dev External call at the end of instant deposit
     ...
     * @param relay External call to make after instant deposit is completed
