...
contract ConvertToShares_Integration_Concrete_Test is MultistrategyHarness_Integration_Shared_Test {
    ...
    function test_ConvertToShares_ZeroAmount() external {
        ...
        uint256 actualShares = IERC4626(address(multistrategyHarness)).convertToShares(0);
    ...
    {
        //Assert that shares for assets is zero when the assets of shares is zero
        uint256 actualShares = IERC4626(address(multistrategyHarness)).convertToShares(assets);
